...
var domAnimation2 = () => import("./dist-GOU6W5UM.js").then((res) => res.default);
...
function useNavbar(originalProps) {
  ...
  const domRef = useDOMRef(ref);
  const prevWidth = (0, import_react5.useRef)(0);
  const navHeight = (0, import_react5.useRef)(0);
  const [isHidden, setIsHidden] = (0, import_react5.useState)(false);
  const handleMenuOpenChange = (0, import_react5.useCallback)(
    (isOpen) => {
...
var domAnimation3 = () => import("./dist-GOU6W5UM.js").then((res) => res.default);
...
function $3017fa7ffdddec74$export$8042c6c013fd5226(props = {}) {
  ...
  let [initialValue] = (0, import_react7.useState)(isSelected);
...
//# sourceMappingURL=chunk-SGF6SAX5.js.map
