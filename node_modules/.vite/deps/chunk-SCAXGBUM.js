...
var require_conversions = __commonJS({
  "node_modules/color-convert/conversions.js"(exports, module) {
    ...
    convert.rgb.hsv = function(rgb) {
      ...
      const g3 = rgb[1] / 255;
      const b = rgb[2] / 255;
      const v = Math.max(r4, g3, b);
      const diff = v - Math.min(r4, g3, b);
    ...
    convert.rgb.cmyk = function(rgb) {
      ...
      const g3 = rgb[1] / 255;
      const b = rgb[2] / 255;
      const k2 = Math.min(1 - r4, 1 - g3, 1 - b);
      const c2 = (1 - r4 - k2) / (1 - k2) || 0;
    ...
    convert.rgb.xyz = function(rgb) {
      ...
      const x2 = r4 * 0.4124 + g3 * 0.3576 + b * 0.1805;
    ...
    convert.cmyk.rgb = function(cmyk) {
      ...
      const y2 = cmyk[2] / 100;
      const k2 = cmyk[3] / 100;
      const r4 = 1 - Math.min(1, c2 * (1 - k2) + k2);
...
var u = (...t) => {
  ...
  return r4.length > 0 ? a(r4.join(" ")) : void 0;
};
var h = (t) => t === false ? "false" : t === true ? "true" : t === 0 ? "0" : t;
var x = (t) => {
  if (!t || typeof t != "object") return true;
  for (let r4 in t) return false;
  return true;
};
var k = (t, r4) => {
  if (t === r4) return true;
  if (!t || !r4) return false;
  let n = Object.keys(t), e = Object.keys(r4);
  if (n.length !== e.length) return false;
  for (let f2 = 0; f2 < n.length; f2++) {
    let s = n[f2];
    if (!e.includes(s) || t[s] !== r4[s]) return false;
  }
  return true;
};
var d = (t, r4) => {
  for (let n in r4) if (Object.prototype.hasOwnProperty.call(r4, n)) {
    let e = r4[n];
...
var c = (t, r4) => {
  for (let n = 0; n < t.length; n++) {
    let e = t[n];
    Array.isArray(e) ? c(e, r4) : e && r4.push(e);
  }
};
var g = (...t) => {
  let r4 = [];
  c(t, r4);
  let n = [];
  for (let e = 0; e < r4.length; e++) r4[e] && n.push(r4[e]);
  return n;
};
var p = (t, r4) => {
  let n = {};
  ...
  for (let e in r4) e in t || (n[e] = r4[e]);
  return n;
};
  ...
  let w = (u3, $) => {
    ...
    let N = x(c$1?.slots), O = x(M) ? {} : { base: u(u3?.base, N && c$1?.base), ...M }, j$1 = N ? O : d({ ...c$1?.slots }, x(O) ? { base: u3?.base } : O), T2 = x(c$1?.compoundVariants) ? L : g(c$1?.compoundVariants, L), y2 = (h2) => {
      ...
      let Y = (t, e, n = [], a$1) => {
        ...
        if (typeof e == "string") {
          let i2 = a(e).split(" ");
          for (let l = 0; l < i2.length; l++) r4.push(`${t}:${i2[l]}`);
        } else if (Array.isArray(e)) for (let s = 0; s < e.length; s++) r4.push(`${t}:${e[s]}`);
        else if (typeof e == "object" && typeof a$1 == "string" && a$1 in e) {
          let s = e[a$1];
          if (s && typeof s == "string") {
            let l = a(s).split(" "), f2 = [];
            for (let o = 0; o < l.length; o++) f2.push(`${t}:${l[o]}`);
            r4[a$1] = r4[a$1] ? r4[a$1].concat(f2) : f2;
        ...
        let V = i2 != null && typeof i2 != "object" ? i2 : h(f2), m = r4[V || "false"];
        ...
        let n = [];
        for (let a2 in p2) {
          let r4 = W(a2, p2, t, e), s = t === "base" && typeof r4 == "string" ? r4 : r4 && r4[t];
          s && n.push(s);
        }
        return n;
      }, z = {};
      ...
      let D = (t, e) => {
        ...
        for (let r4 = 0; r4 < a2; r4++) {
          let { class: s, className: i2, ...l } = t[r4], f2 = true, o = D(null, e);
          for (let V in l) {
            let m = l[V], C2 = o[V];
            if (Array.isArray(m)) {
              if (!m.includes(C2)) {
        ...
        for (let a2 = 0; a2 < v.length; a2++) {
          let { slots: r4 = [], class: s, className: i2, ...l } = v[a2];
          if (!x(l)) {
            let f2 = true;
            for (let o in l) {
              let V = n[o], m = l[o];
      ...
      if (!x(M) || !N) {
        ...
        if (typeof j$1 == "object" && !x(j$1)) {
          ...
          for (let n in j$1) t[n] = (a2) => {
            let r4 = K(a2), s = ee(a2);
            return e(j$1[n], _(n, a2), r4 ? r4[n] : void 0, s ? s[n] : void 0, a2?.class, a2?.className)(d$1);
          };
        }
        return t;
      }
...
function getLuminance(color) {
  ...
  return 0.2126 * f2(r4) + 0.7152 * f2(g3) + 0.0722 * f2(b);
}
  ...
  for (const [themeName, { extend, layout, colors: colors2 }] of Object.entries(themes)) {
    ...
    for (const [colorName, colorValue] of Object.entries(flatColors)) {
      ...
      try {
        ...
        const [h2, s, l, defaultAlphaValue] = parsedColor;
        const herouiColorVariable = `--${prefix}-${colorName}`;
        resolved.utilities[cssSelector][herouiColorVariable] = `${h2} ${s}% ${l}%`;
        baseSelector && (resolved.baseStyles[baseSelector][herouiColorVariable] = `${h2} ${s}% ${l}%`);
...
function r3(e) {
  ...
  if ("string" == typeof e || "number" == typeof e) n += e;
    ...
    var o = e.length;
    for (t = 0; t < o; t++) e[t] && (f2 = r3(e[t])) && (n && (n += " "), n += f2);
  } else for (f2 in e) e[f2] && (n && (n += " "), n += f2);
  return n;
}
function clsx3() {
  for (var e, t, f2 = 0, n = "", o = arguments.length; f2 < o; f2++) (e = arguments[f2]) && (t = r3(e)) && (n && (n += " "), n += t);
  return n;
}
var clsx_default = clsx3;
...
var $ae1eeba8b9eafd08$export$5165eccb35aaadb5 = (0, import_react26.default).createContext({
  register: () => {
  }
});
...
function $f6c31cce2adf654f$var$usePressResponderContext(props) {
  let context = (0, import_react27.useContext)((0, $ae1eeba8b9eafd08$export$5165eccb35aaadb5));
  if (context) {
...
function $f6c31cce2adf654f$export$45712eceda6fad21(props) {
  ...
  let [isPressed, setPressed] = (0, import_react27.useState)(false);
  let ref = (0, import_react27.useRef)({
    isPressed: false,
  ...
  let pressProps = (0, import_react27.useMemo)(() => {
    let state = ref.current;
    let pressProps2 = {
      onKeyDown(e) {
...
function $507fabe10e71c6fb$export$98e20ec92f614cfe() {
  ...
  let [modality, setModality] = (0, import_react28.useState)($507fabe10e71c6fb$var$currentModality);
...
function $a1ea59d68270f0dd$export$f8168d8dd8fd66e6(props) {
  ...
  const onBlur = (0, import_react29.useCallback)((e) => {
  ...
  const onFocus = (0, import_react29.useCallback)((e) => {
...
var $f645667febf57a63$export$f9762fab77588ecb = (0, import_react30.default).createContext(null);
function $f645667febf57a63$var$useFocusableContext(ref) {
  let context = (0, import_react30.useContext)($f645667febf57a63$export$f9762fab77588ecb) || {};
  (0, $e7801be82b4b2a53$export$4debdb1a3f0fa79e)(context, ref);
  let { ref: _, ...otherProps } = context;
  return otherProps;
}
var $f645667febf57a63$export$13f3202a3e5ddd5 = (0, import_react30.default).forwardRef(function FocusableProvider(props, ref) {
  ...
  return (0, import_react30.default).createElement($f645667febf57a63$export$f9762fab77588ecb.Provider, {
    value: context
  }, children);
});
function $f645667febf57a63$export$4c014de7c8940b4c(props, domRef) {
  ...
  let autoFocusRef = (0, import_react30.useRef)(props.autoFocus);
...
var $f645667febf57a63$export$35a3bebf7ef2d934 = (0, import_react30.forwardRef)(({ children, ...props }, ref) => {
...
var $3b117e43dc0ca95d$export$27c701ed9e449e99 = (0, import_react31.default).forwardRef(({ children, ...props }, ref) => {
  ref = (0, $df56164dff5785e2$export$4338b53315abf666)(ref);
...
var $f1ab8c75478c6f73$export$3351871ee4b288b8 = (0, import_react32.default).forwardRef(({ children, ...props }, ref) => {
  let isRegistered = (0, import_react32.useRef)(false);
  let prevContext = (0, import_react32.useContext)((0, $ae1eeba8b9eafd08$export$5165eccb35aaadb5));
  ...
  return (0, import_react32.default).createElement((0, $ae1eeba8b9eafd08$export$5165eccb35aaadb5).Provider, {
    value: context
  }, children);
});
...
function $9ab94262bd0047c7$export$420e68273165f4ec(props) {
  ...
  let { addGlobalListener, removeAllGlobalListeners } = (0, $03deb23ff14920c4$export$4eaf04e54aa8eed6)();
  let onBlur = (0, import_react33.useCallback)((e) => {
  ...
  let onFocus = (0, import_react33.useCallback)((e) => {
    if (!e.currentTarget.contains(e.target)) return;
    const ownerDocument = (0, $431fbd86ca7dc216$export$b204af158042fbac)(e.target);
    const activeElement = (0, $d4ee10de306f2510$export$cd4e5573fbe2b576)(ownerDocument);
...
function $6179b936705e76d3$export$ae780daf29e6d456(props) {
  ...
  let [isHovered, setHovered] = (0, import_react34.useState)(false);
  ...
  (0, import_react34.useEffect)($6179b936705e76d3$var$setupGlobalTouchEvents, []);
  let { addGlobalListener, removeAllGlobalListeners } = (0, $03deb23ff14920c4$export$4eaf04e54aa8eed6)();
  let { hoverProps, triggerHoverEnd } = (0, import_react34.useMemo)(() => {
...
function $e8a7022cf87cba2a$export$36da96379f79f245(props) {
  ...
  let moveProps = (0, import_react36.useMemo)(() => {
    let moveProps2 = {};
    let start = () => {
...
function $7d0a636d7a4dcefd$export$2123ff2b87c81ca(props, ref) {
  ...
  let onScrollHandler = (0, import_react37.useCallback)((e) => {
    if (e.ctrlKey) return;
    e.preventDefault();
    e.stopPropagation();
...
function $8a26561d2877236e$export$c24ed0104d07eab9(props) {
  ...
  const timeRef = (0, import_react38.useRef)(void 0);
  let { addGlobalListener, removeGlobalListener } = (0, $03deb23ff14920c4$export$4eaf04e54aa8eed6)();
  let { pressProps } = (0, $f6c31cce2adf654f$export$45712eceda6fad21)({
    isDisabled,
    onPressStart(e) {
...
function $5c3e21d68f1c4674$export$a966af930f325cab(props = {}) {
  ...
  let combinedStyles = (0, import_react39.useMemo)(() => {
...
function $5c3e21d68f1c4674$export$439d29a4e110a164(props) {
  ...
  return (0, import_react39.default).createElement(Element2, (0, $3ef42575df84b30b$export$9d1611c77c2fe928)(otherProps, visuallyHiddenProps), children);
}
...
function $1e5a04cdaf7d1af8$export$188ec29ebc2bdc3a() {
  ...
  let [defaultLocale, setDefaultLocale] = (0, import_react40.useState)($1e5a04cdaf7d1af8$var$currentLocale);
...
var $18f2051aff69b9bf$var$I18nContext = (0, import_react41.default).createContext(null);
function $18f2051aff69b9bf$var$I18nProviderWithLocale(props) {
  let { locale, children } = props;
  let value = (0, import_react41.default).useMemo(() => ({
    locale,
    direction: (0, $148a7a147e38ea7f$export$702d680b21cbd764)(locale) ? "rtl" : "ltr"
  }), [
    locale
  ]);
  return (0, import_react41.default).createElement($18f2051aff69b9bf$var$I18nContext.Provider, {
    value
  }, children);
}
...
function $18f2051aff69b9bf$export$a54013f0d02a8f82(props) {
  let { locale, children } = props;
  if (locale) return (0, import_react41.default).createElement($18f2051aff69b9bf$var$I18nProviderWithLocale, {
    locale,
    children
  });
  return (0, import_react41.default).createElement($18f2051aff69b9bf$var$I18nProviderWithDefaultLocale, {
    children
  });
}
function $18f2051aff69b9bf$export$43bb16f9c6d9e3f7() {
  let defaultLocale = (0, $1e5a04cdaf7d1af8$export$188ec29ebc2bdc3a)();
  let context = (0, import_react41.useContext)($18f2051aff69b9bf$var$I18nContext);
...
function $fca6afa0e843324b$export$f12b703ca79dfbb1(strings, packageName) {
  ...
  return (0, import_react43.useMemo)(() => new (0, $6db58dc88e78b024$export$2f817fcdc4b89ae0)(locale, dictionary), [
    locale,
    dictionary
  ]);
}
...
function $896ba0a80a8f4d36$export$85fd5fdf27bacc79(options) {
  ...
  let { locale } = (0, $18f2051aff69b9bf$export$43bb16f9c6d9e3f7)();
  return (0, import_react45.useMemo)(() => new (0, $fb18d541ea1ad717$export$ad991b66133851cf)(locale, options), [
    locale,
    options
  ]);
}
...
function $a916eb452884faea$export$b7a616150fdb9f44(options = {}) {
  let { locale } = (0, $18f2051aff69b9bf$export$43bb16f9c6d9e3f7)();
  return (0, import_react46.useMemo)(() => new (0, $488c6ddbf4ef74c2$export$cc77c4ff7e8673c5)(locale, options), [
    locale,
    options
  ]);
}
...
function $bb77f239b46e8c72$export$3274cf84b703fff(options) {
  ...
  let startsWith4 = (0, import_react47.useCallback)((string, substring) => {
  ...
  let endsWith = (0, import_react47.useCallback)((string, substring) => {
    if (substring.length === 0) return true;
    string = string.normalize("NFC");
    substring = substring.normalize("NFC");
  ...
  let contains = (0, import_react47.useCallback)((string, substring) => {
    if (substring.length === 0) return true;
    string = string.normalize("NFC");
    substring = substring.normalize("NFC");
    let scan = 0;
...
function $2a41e45df1593e64$export$d39e1813b3bdd0e1(props) {
  ...
  let [position, setPosition] = (0, import_react49.useState)(null);
  let deps = [
  ...
  const customTv = tv(
    {
      ...
      defaultVariants: defaultVariants && typeof defaultVariants === "object" ? (
        ...
        Object.keys(defaultVariants).filter((k2) => !keys.includes(k2)).reduce((o, k2) => {
          o[k2] = defaultVariants[k2];
          return o;
        }, [])
      ) : defaultVariants,
      compoundVariants,
...
//# sourceMappingURL=chunk-SCAXGBUM.js.map
