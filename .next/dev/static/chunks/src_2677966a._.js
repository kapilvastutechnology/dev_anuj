...
"[project]/src/lib/data:09bcfc [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
 ...
 //# sourceMappingURL=data:application/json;base64,
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$09bcfc__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:09bcfc [app-client] (ecmascript) <text/javascript>");
...
function EmployeeAdd() {
    ...
    if ($[0] !== "0764427bb2690a1c9bd3ea4be1ff2ab978600b6005766cc7127b60887cf3135d") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "0764427bb2690a1c9bd3ea4be1ff2ab978600b6005766cc7127b60887cf3135d";
    }
    ...
    if ($[3] !== router) {
        t2 = ({
            "EmployeeAdd[<Formik>.onSubmit]": async (val)=>{
                startTransition({
                    "EmployeeAdd[<Formik>.onSubmit > startTransition()]": async ()=>{
                        ;
                        try {
                            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$09bcfc__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["addEmployee"])(val);
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(res.message);
                            router.back();
                        } catch (t3) {
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to add employee");
                        }
                    }
    ...
    if ($[5] !== loading) {
        t3 = (t4)=>{
            const { handleSubmit, handleChange, values } = t4;
...
//# sourceMappingURL=src_2677966a._.js.map